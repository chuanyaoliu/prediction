...
def test():
    ...
    for (x,y) in zip(cap[1:],T1[1:]):
        ...
        if i<cricle:
            ...
            loss = loss_func(  torch.FloatTensor([pre2])*maxcap,ca*maxcap)
    ...
    if cricle==70:
        ...
        plt.text(102, 1.55, r'102', fontsize=10)
        plt.vlines(95, 1.2,1.6 , color='#984EA3')
        plt.text(90, 1.55, r'95', fontsize=10)
        plt.vlines(90, 1.2,1.6 , color='#4DAF4A')
        plt.text(87, 1.62, r'90', fontsize=10)
