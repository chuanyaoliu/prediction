...
def drawFour():
    path = './nasa/B0005.mat'
    cap5,T1,X5 = readmat(path)
    path = './nasa/B0006.mat'
    cap6,T1,X6 = readmat(path)
    path = './nasa/B0007.mat'
    cap7,T1,X7 = readmat(path)
    path = './nasa/B0018.mat'
    cap18,T1,X18 = readmat(path)
    plt.plot(X5,cap5,label='B0005')
    plt.plot(X6, cap6,label='B0006')
    plt.plot(X7,cap7,label='B0007')
    plt.plot(X18,cap18,label='B0018')
    plt.legend(loc='upper right', fontsize=10);
    plt.xlabel('Cycle')
    plt.ylabel('Capacity (Ahr)')
    #plt.hlines(1.4, 0,175 ,  linestyles = "dashed")
    plt.show()
