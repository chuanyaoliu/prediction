...
# Hyper Parameters
BATCH_SIZE = 64
LR_G = 0.000001 # learning rate for generator
...
G = nn.Sequential(                  # Generator
    ...
    nn.ReLU(),
    nn.Linear(64, 4), # making a painting from these random ideas
...
#G = torch.load('./model/gongshi9900.pkl')
...
for step in range(10000):
    ...
    if step % 100 == 0:  # plotting
        ...
        model_name = "./model/gongsh"+str(step)+".pkl"
